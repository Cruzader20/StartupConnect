...
const App = () => {
  ...
  return (
    ...
    <View>
    <Pressable onPress={() => setactivescreen('Details')}> 
    <Fontisto name="linux" size={34} color={activescreen == 'Details' ? color:"#4287f5"} />
    </Pressable>
    </View>  
    <View>
    ...
    <FontAwesome name="user" size={34} color={activescreen == 'Profile' ? color:"#4287f5"} />
      ...
      {activescreen=='Details'&& <UserDetails></UserDetails>}
    </View>
    </SafeAreaView>
  )
}
